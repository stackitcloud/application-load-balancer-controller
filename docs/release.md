...
This document outlines the standard procedure for creating new releases of the STACKIT application-load-balancer-controller.
...
5. Once the cherry-pick PR has been reviewed, approved, and merged, you can promote the changes by creating a new patch release of application-load-balancer-controller.
