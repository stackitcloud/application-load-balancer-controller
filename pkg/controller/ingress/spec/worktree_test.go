...
var _ = Describe("WorkTreeALB", func() {
	...
	DescribeTable("parsing ingress class annotation", func(key, value, expectErr string) {
		...
		Entry("allowed source range - duplicate", AnnotationAllowedSourceRanges, "10.0.0.0/24,10.5.0.0/8,10.0.0.0/24",
			"duplicate range in annotation alb.stackit.cloud/allowed-source-ranges"),
