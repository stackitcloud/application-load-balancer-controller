# Contributing to `application-load-balancer-controller`

Welcome and thank you for making it this far and considering contributing to `application-load-balancer-controller`.
...
For major changes, API changes or features please open an [Issue](https://github.com/stackitcloud/application-load-balancer-controller/issues) beforehand to clarify if this is in line with the project and to avoid unnecessary work.
